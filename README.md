...
I'm a **ML Engineer** specializing in production AI systems:
- **Vision-Language Models** (VLM) & Large Language Models deployment
- **Computer Vision** & Document AI (OCR, layout analysis)
- **MLOps** & Infrastructure (Docker, vLLM, multi-GPU inference)
